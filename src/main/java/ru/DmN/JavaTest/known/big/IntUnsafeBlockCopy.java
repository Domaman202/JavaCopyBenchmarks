...
public class IntUnsafeBlockCopy {
    ...
    static {
        try {
            ...
            forceAccess(offset);
            FIRST = (long) offset.invoke(UNSAFE, BigDataClass.class, "i0");
            MEM_COPY = MethodHandles.insertArguments(MethodHandles.insertArguments(MethodHandles.insertArguments(lookup.unreflect(Class.forName("jdk.internal.misc.Unsafe").getDeclaredMethod("copyMemory0", Object.class, long.class, Object.class, long.class, long.class)).bindTo(UNSAFE), 1, FIRST), 2, FIRST), 2, 1024);
